...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
        <form method="GET" action="{{ route('catalog.index') }}" class="flex flex-col sm:flex-row gap-3">
            {{-- Search Input --}}
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            @foreach($items as $item)
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300 flex flex-col">
                    {{-- Image Placeholder --}}
                    <div class="h-48 bg-gray-50 border-b border-gray-100 flex items-center justify-center relative">
