...
<div class="mx-auto max-w-5xl space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="min-w-0">
            ...
            <h2 class="hmif-break-anywhere mt-2 text-xl font-bold text-gray-900 sm:text-2xl">{{ $item->name }}</h2>
        ...
        <div class="rounded-xl border border-gray-100 bg-white p-4 shadow-sm sm:p-6">
            ...
            <div class="mt-6 grid gap-4 sm:grid-cols-2">
                ...
                <div class="rounded-lg bg-gray-50 p-4">
                    ...
                    <p class="hmif-break-anywhere mt-2 font-semibold text-gray-900">{{ $item->location ?? 'Tidak ada lokasi' }}</p>
                </div>
                <div class="rounded-lg bg-gray-50 p-4">
            ...
            <div class="mt-6">
                ...
                <p class="hmif-break-anywhere mt-2 whitespace-pre-line rounded-lg bg-gray-50 p-4 text-sm leading-6 text-gray-700">
